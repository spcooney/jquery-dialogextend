...
(function () {
    ...
    $.extend(true, $.ui.dialogExtend.prototype, {
        ...
        _initStyles_refresh: function () {
            var style;
            if (!$(".dialog-extend-refresh-css").length) {
                style = '';
                style += '<style class="dialog-extend-refresh-css" type="text/css">';
                style += '.ui-dialog .ui-dialog-titlebar-refresh { width: 19px; height: 18px; }';
                style += '.ui-dialog .ui-dialog-titlebar-refresh span { display: block; margin: 1px; }';
                style += '.ui-dialog .ui-dialog-titlebar-refresh:hover,';
                style += '.ui-dialog .ui-dialog-titlebar-refresh:focus { padding: 0; }';
                style += '</style>';
                return $(style).appendTo("body");
            }
        }
